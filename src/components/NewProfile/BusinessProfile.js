...
function BusinessProfile(props) {
  ...
  useEffect(() => {
    if (props.auth && props.auth.user && props.auth.user.lawfirm_user) {
      ...
      props.actions.getLawfirmUserProfile(
        props.auth.user.lawfirm_user.id
          ? props.auth.user.lawfirm_user.id
          : props.auth.user.lawfirm_user,
        props.history
      );
  ...
  useEffect(() => {
    ...
    if (
      props.location.pathname === "/lawfirm/profile" ||
      props.location.pathname === "/lawfirm/"
    ) {
      console.log("hi");
      setActiveMenu(1);
    }
    ...
    if (
      props.location.pathname == "/lawfirm/blogs" ||
      props.location.pathname.includes("/lawfirm/blogs/")
    ) {
      setActiveMenu(8);
    }
  ...
  useEffect(() => {
    ...
    let count = false;
    if (
      props.lawfirm_user.branches &&
      props.lawfirm_user.branches.length !== 0
    ) {
    ...
    <div className={`newProfile ${sidebarCollapse ? "" : "sidebar-collapse"}`}>
      <div className="sidebar">
        <div className="sidebar-head">
          <h3>
            {props.lawfirm_user && props.lawfirm_user.firstname
              ? props.lawfirm_user.firstname
              : ""}{" "}
            {props.lawfirm_user && props.lawfirm_user.lastname
              ? props.lawfirm_user.lastname
              : ""}{" "}
            {!props.lawfirm_user.firstname && "User Profile"}
          </h3>
          <p>Lawfrim User</p>
          ...
          <ul>
            ...
            <Link to="/lawfirm/branches" data-tooltip="branches">
              <li className={activeMenu === 9 ? "active" : ""}>
                <span></span> <i className="fa fa-star-o" />{" "}
                <span className="link-title">Location</span>
              </li>
            </Link>

            <Link to="/lawfirm/documents" data-tooltip="Order History">
              <li className={activeMenu === 2 ? "active" : ""}>
                <span></span> <i className="fa fa-gift stroke-transparent" />
            ...
            <Link to="/lawfirm/lawyers" data-tooltip="Payment History">
              <li className={activeMenu === 3 ? "active" : ""}>
                <span></span> <i className="fa fa-star-o" />
                <span className="link-title">Lawyers</span>
              </li>
            </Link>
            ...
            <Link to="/lawfirm/chats" data-tooltip="Messaging">
              <li className={activeMenu === 7 ? "active" : ""}>
                <span></span> <i className="fa fa-cog stroke-transparent" />{" "}
         ...
         */}
            ...
            <Link>
              <li
                ...
                style={{ color: "grey" }}
              >
                <span></span> <i className="fa fa-cog" />{" "}
                <span className="link-title">Messaging</span>
              </li>
            </Link>
            <Link>
              <li
                ...
                style={{ color: "grey" }}
              >
                <span></span> <i className="fa fa-gift" />{" "}
                <span className="link-title">Blogs</span>
              </li>
            </Link>
