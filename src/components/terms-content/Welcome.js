...
const Welcome = ({title}) => {
    return (
      ...
      <p>By accessing this website or using the Services, you are agreeing to the Terms, Legaltek's Privacy Policy and Legaltek's Community Guidelines. If you have any questions, please <a style={{textDecoration:"underline", color:"blue"}}>contact us</a>.</p>
            </div>
        </div>
    )
}
