...
function LoginWithPhone(props) {
  ...
  const [countryCode, setCountryCode] = useState({
    value: localStorage.getItem("calling_code")
      ? localStorage.getItem("calling_code")
      : "",
    message: "",
    isValid: true,
  });
  ...
  const [userType, setUserType] = useState(
    props.location && props.location.state && props.location.state.userType
    ...
    <div id="login">
        ...
        <div className="brand">
          ...
          <div className="form">
            ...
            <h4 style={{ textAlign: "left" }}>
              {props.regProp ? "or Sign up with" : "or Sign in with"}
            </h4>
            <div className="social_btns">
              <div>
                <div className="social_btn">
                  <Link
                    to={{ pathname: "/login", state: { userType: userType } }}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      width: "100%",
      ...
      v20.341H37.29v27.585h23.814v70.761H89.584z"
          ...
          >
            <p style={{ fontSize: 12 }}>
              Forgot Password?
              <Link style={{ fontSize: 12 }} to="/forgotPassword">
                &nbsp;Reset
              </Link>
            </p>
