...
class Profile extends Component {
  ...
  saveProfile = async (e) => {
    ...
    if(!valid==false){
      ...
      message.error("Check for errors!")
    }
              ...
              <>
                <div className="input-row">
                  <label className="fullLabel">
                    ...
                    <input value={this.state.deliveryLocationInfo[index] && this.state.deliveryLocationInfo[index].address} onChange={(e) => this.changeAddressInfo(e, index)} name="address" placeholder="Delivery address" disabled={this.state.deliveryLocationInfo[index].disabled && this.state.deliveryLocationInfo[index].disabled}/>
                  </label>
                </div>
                ...
                <div className="input-row three-part">
                  <label className="one-third">
                    ...
                    <input
                    name="city"
                     disabled={this.state.deliveryLocationInfo[index].disabled && this.state.deliveryLocationInfo[index].disabled}
                      placeholder="City"
                      value={this.state.deliveryLocationInfo[index].city}
                  ...
                  <label className="one-third">
                    ...
                    <input
                    name="state"
                    value={this.state.deliveryLocationInfo[index].state}
                    disabled={this.state.deliveryLocationInfo[index].disabled && this.state.deliveryLocationInfo[index].disabled}
                     onChange={(e) => this.changeAddressInfo(e, index)}
                    placeholder="Province/State" />
                  </label>
                  <label className="one-third">
                    ...
                    <input
                    name="zip"
                    value={this.state.deliveryLocationInfo[index].zip}
                    disabled={this.state.deliveryLocationInfo[index].disabled && this.state.deliveryLocationInfo[index].disabled}
                     onChange={(e) => this.changeAddressInfo(e, index)}
                    placeholder="Postal/Zip Code" />
                  </label>
            ...
            >
              {this.state.profCompDiv && (
                <div className="profile-completion-div">
                  ...
                  <ul>
                  <li>
                      <div className={`checkmark avatar ${this.state.profileCompletion.profile && 'active'}`}>
                    ...
                    <li>
                      <div className={`checkmark avatar active ${this.state.profileCompletion.account && 'active'}`}>
                        <i className="fa fa-check" />
                      </div>
